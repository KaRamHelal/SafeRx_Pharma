...
**Available conditions:** `arrhythmia`, `asthma`, `bph`, `coronary`, `depression`, `diabetes`, `epilepsy`, `gi_bleeding`, `glaucoma`, `heart_failure`, `hypertension`, `hyperthyroidism`, `hypothyroidism`, `parkinsons`
...
- **[API Reference](/api-reference/getting-started/quickstart)** — Full endpoint documentation
- **[Rate Limits](/api-reference/authentication/rate-limits)** — Tier details and retry strategies
- **[Pharmacy Dispensing Guide](/guides/integration-guides/pharmacy-dispensing)** — End-to-end pharmacy workflow
