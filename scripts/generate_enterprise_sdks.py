...
# The current release line is v2.0.0+ (see RELEASE_CHECKLIST.md / release/current.yaml).
# Pre-2.0 0.x/rc candidate versions must not reappear in generated artifacts.
SDK_VERSION = "2.0.2"
