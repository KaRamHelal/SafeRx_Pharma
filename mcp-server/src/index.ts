...
const USER_AGENT = "SafeRx-MCP-Server/2.0.1";
...
server.tool(
  "check_drug_safety",
  "Screen drugs for safety issues across 6 domains: adverse effects (Black Box Warnings, monitoring), drug interactions, pregnancy/lactation risks, food interactions, clinical considerations, and dosing. Covers 33,000 Egyptian pharma and semi-pharma products with bilingual EN/AR support.",
  {
    drugs: z
      .array(z.string())
      .min(1)
