...
def generate(verify: bool = False) -> int:
    ...
    files = {
        ...
        OUT / "python/pyproject.toml": '''[project]\nname = "saferx-pharma"\nversion = "0.1.0rc1"\nrequires-python = ">=3.11"\ndependencies = []\n''',
    ...
    manifest = {
        "release_id": "mis-enterprise-2026.07.28-authenticated.1",
        "release_state": "authenticated_api_available_packages_internal",
    ...
    sbom = {"bomFormat": "CycloneDX", "specVersion": "1.6", "version": 1, "metadata": {"component": {"type": "application", "name": "saferx-enterprise-sdks", "version": "0.1.0-rc.1"}}, "components": []}
    write(OUT / "sbom.cdx.json", json.dumps(sbom, indent=2, sort_keys=True) + "\n")
    provenance = {"_type": "https://in-toto.io/Statement/v1", "predicateType": "https://slsa.dev/provenance/v1", "subject": [{"name": name, "digest": {"sha256": digest}} for name, digest in sorted(artifact_hashes.items())], "predicate": {"buildType": "saferx.mis/enterprise-sdk-generator", "generator": "scripts/generate_enterprise_sdks.py", "materials": [{"uri": name, "digest": {"sha256": digest}} for name, digest in sorted(source_hashes.items())]}}
