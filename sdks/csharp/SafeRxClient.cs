...
public sealed class SafeRxClient
{
    ...
    public static readonly IReadOnlyDictionary<string, EnterpriseOperation> Operations = new Dictionary<string, EnterpriseOperation>
    {
        ...
        ["enterprise_ocr_prescription_read"] = new EnterpriseOperation("enterprise_ocr_prescription_read", HttpMethod.Get, "/ocr/prescriptions/{prescription_id}", "enterprise_unknown", "rp_enterprise_default", "enterprise_request", false),
        ["enterprise_ocr_prescription_resolve"] = new EnterpriseOperation("enterprise_ocr_prescription_resolve", HttpMethod.Post, "/ocr/prescriptions/{prescription_id}/medications/resolve", "enterprise_unknown", "rp_enterprise_default", "enterprise_request", false),
        ["enterprise_ocr_prescription_review"] = new EnterpriseOperation("enterprise_ocr_prescription_review", HttpMethod.Post, "/ocr/prescriptions/{prescription_id}/review", "enterprise_unknown", "rp_enterprise_default", "enterprise_request", false),
        ["enterprise_ocr_prescription_safety"] = new EnterpriseOperation("enterprise_ocr_prescription_safety", HttpMethod.Post, "/ocr/prescriptions/{prescription_id}/safety-checks", "enterprise_unknown", "rp_enterprise_default", "enterprise_request", false),
        ["enterprise_registry_autocomplete"] = new EnterpriseOperation("enterprise_registry_autocomplete", HttpMethod.Get, "/registry/suggest", "enterprise_unknown", "rp_enterprise_default", "enterprise_request", false),
        ["enterprise_registry_ingredients"] = new EnterpriseOperation("enterprise_registry_ingredients", HttpMethod.Get, "/registry/ingredients", "enterprise_unknown", "rp_enterprise_default", "enterprise_request", false),
        ["enterprise_registry_product_detail"] = new EnterpriseOperation("enterprise_registry_product_detail", HttpMethod.Get, "/registry/products/{sfrx_id}", "enterprise_unknown", "rp_enterprise_default", "enterprise_request", false),
        ["enterprise_registry_resolve"] = new EnterpriseOperation("enterprise_registry_resolve", HttpMethod.Post, "/registry/resolve", "enterprise_unknown", "rp_enterprise_default", "enterprise_request", false),
