...
Model Context Protocol server for the [SafeRx Drug Safety API](https://saferx.online). Enables AI assistants (Claude Desktop, Claude Code, Cursor) to check drug safety across 33,000 Egyptian pharma and semi-pharma products.
