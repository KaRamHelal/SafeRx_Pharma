...
This package remains `internal_only` per SafeRx's internal availability
configuration — it is not part of the supported Enterprise API surface and is not a
